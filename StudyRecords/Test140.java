...
○ String 클래스 간에 『+』 연산자를 사용하게 되면
   ...
   ※ 눈으로 확인되는 결과는 이렇지만...
	  ...
	  append() 메소드를 이용해 무자열에 대한 결합을 수행하게 된다.
	  ...
	  ==> 정적인 문자열을 처리하는 경우에는 주로 String 클래스를 사용
		  동적인 문자열을 처리하는 경우에는 런타임시 동적으로 처리해주는
...
//		※ String 클래스는 Object 클래스의 equals() 를 Overrideing~!!!
...
//		※ 객체가 같으면 hashcode가  같지만... hashcode 가 같다고 같은 객체는 아니다.
